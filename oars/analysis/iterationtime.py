...
def getCycleTime(t, l, Z, W, itrs=None):
    ...
    Z: n x n array of resolvent multipliers
    W: n x n array of consensus multipliers
    Outputs:
    cycle_length: cycle time
    s: 3n-1 x n array of start times for each agent in each iteration
    X: n x n array of communication relationships
...
def getGantt(t, l, Z, W, title="Example", itrs=None):
    ...
    itrs: number of iterations, 2n by default 
