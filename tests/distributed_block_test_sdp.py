...
proxlist = [nlinearSubdiff, ntraceEqualityIndicator, npsdCone, ntraceEqualityIndicator] + [ntraceHalfspaceIndicator for _ in Kp]
...
x, results = distributed_block_solve(dim, data, proxlist, warmstartprimal=warmstart, itrs=10001, gamma=0.99, vartol=1e-5, verbose=True)
# Fiedler 0.157, 0.243 
# Similar 0, 4/dim (0.4)
